...
public class UserServiceImpl implements UserService {
     ...
     */
    @Override
    public int count(Integer gradeId ,String name) {
        return userMapper.getCount(gradeId,name);
    }
     ...
     */
    @Override
    public IPage<User> getPageUser(Page page, Integer gradeId, String name) {
        IPage<User> pageUser = userMapper.selectPageUser(page, gradeId, name);
